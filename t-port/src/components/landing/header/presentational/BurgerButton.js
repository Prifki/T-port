...
class BurgerButton extends Component {
  render() {
    return (
    <div className="header__burger-wrapper" onClick={this.props.onClick} >
            <svg className={this.props.isBurgerButtonActive ? "header__burger header__burger--rotate active" : "header__burger header__burger--rotate"} viewBox="0 0 100 100" width="50">
