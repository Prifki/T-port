...
function BurgerButton(props) {
    return (
    <div className="header__burger-wrapper" onClick={props.onClick} >
            <svg className={props.isBurgerButtonActive ? "header__burger header__burger--rotate active" : "header__burger header__burger--rotate"} viewBox="0 0 100 100" width="50">
