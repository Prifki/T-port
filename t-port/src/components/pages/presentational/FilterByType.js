    ...
    return (
      <div className="filters">
        <div className="filters--by-type">
            ...
            <label htmlFor="bus" className="filters--by-type__item filters--by-type__item--first" onClick={this.props.filterByBus} ><i className="material-icons">directions_bus</i> Bus</label>

            <input type="checkbox" name="troll" checked={this.props.isFilteredByTroll} onChange={()=>{}} />
            <label htmlFor="train" className="filters--by-type__item" onClick={this.props.filterByTroll} ><i className="material-icons">train</i> Trolley</label>

            <input type="checkbox" name="tram" checked={this.props.isFilteredByTram} onChange={()=>{}} />
            <label htmlFor="tram" className="filters--by-type__item filters--by-type__item--last" onClick={this.props.filterByTram} ><i className="material-icons">tram</i> Tram</label>
        </div>
      </div>
    );
  }
